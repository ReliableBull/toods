...
class ConfirmEditDialog extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ConfirmEditDialgState();
}

class _ConfirmEditDialgState extends ConsumerState<ConfirmEditDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: TextField(
        ...
        autofocus: true,
        decoration:
            InputDecoration(errorText: error ? 'Value cannot be empty' : null),
      ),
      actions: [
        TextButton(
          ...
          onPressed: () {
            ...
            if (error) {
              ...
              ref
                  ...
                  .editTodo(widget.todo.id, textController.text.toString());
